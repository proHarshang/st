...
import { FaFacebookF, FaInstagram, FaPinterest, FaYoutube, FaLinkedinIn, FaTiktok } from "react-icons/fa";
...
const FooterSM = () => {
  ...
  const accordionData = [
    ...
    {
      title: t('footer.May We Help You ?'),
      content: <ul className='flex flex-col gap-1'>
  ...
  return (
    <div className='md:hidden pt-12'>
      <ul className='footerSM p-[1.25rem] flex flex-col items-start gap-5 '>
        <li id='region_selection' className='flex gap-5 max-sm:gap-5 sm:gap-7 align-baseline'>
          ...
          <form>
            ...
            <ul role="list" className={`countryList disclosure__list left-1/3 max-sm:left-full max-sm:shadow-lg ${isLang_selection ? 'block' : 'hidden'}`}>
              ...
              <li className="disclosure__item" tabIndex={-1}>
                <Link to="#" onClick={handleClickedRegion} data-value="en">
                  English (en)
                </Link>
              </li>
              <li className="disclosure__item" tabIndex={-1}>
              ...
              <li className="disclosure__item" tabIndex={-1}>
                <Link to="#" onClick={handleClickedRegion} data-value="ca">
                  canada (ca)
                </Link>
              </li>
            </ul>
        ...
        <li id='currency_selection' className='flex max-sm:gap-5 sm:gap-7 align-baseline'>
          ...
          <form className='w-fit flex flex-col-reverse'>
            ...
            <ul role="list" className={`currencyList disclosure__list mb-3 left-1/3 p-3 max-sm:left-full max-sm:shadow-lg ${isCurrency_selection ? 'flex flex-col items-start gap-2' : 'hidden'}`}>
              <li className="disclosure__item" tabIndex={-1}>
      ...
      <div className='content-center flex flex-col flex-wrap -mt-12 items-start w-full'>
        <div className="cursor-pointer mx-auto mt-11 w-full">
          {accordionData.map((item, index) => (
            <AccordionItem key={index} item={item} />
          ))}
        </div>
        <ul className='flex justify-evenly py-7 w-full'>
          <li><a href="#"><FaTiktok style={{ width: '1.75rem', height: '1.75rem' }} /></a></li>
          <li><a href="#"><FaFacebookF style={{ width: '1.75rem', height: '1.75rem' }} /></a></li>
          <li><a href="#"><FaInstagram style={{ width: '1.75rem', height: '1.75rem' }} /></a></li>
          <li><a href="#"><FaXTwitter style={{ width: '1.75rem', height: '1.75rem' }} /></a></li>
          <li><a href="#"><FaPinterest style={{ width: '1.75rem', height: '1.75rem' }} /></a></li>
          <li><a href="#"><FaYoutube style={{ width: '1.75rem', height: '1.75rem' }} /></a></li>
          <li><a href="#"><FaLinkedinIn style={{ width: '1.75rem', height: '1.75rem' }} /></a></li>
        </ul>
      </div>
...
const AccordionItem = ({ item }) => {
  ...
  return (
    ...
    <div className='p-[1.25rem]'>
      <div
        style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', padding: '0.25rem', borderTop: isActive ? '1px solid #000' : '1px solid #000' }}
        onClick={() => setIsActive(!isActive)}
      >
        <div className='font-extrabold' color='black'>{title}</div>
        <div style={{ fontSize: '1.25rem' }}><GoChevronDown /></div>

      </div>
      {isActive && <div style={{ marginTop: '0.5rem', padding: '0.25rem', fontWeight: 'lighter' }}>{content}</div>}
    </div>
  );
};
